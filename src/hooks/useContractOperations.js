...
export default  function useContract(){
    ...
    const getAccountInfo = async()=>{
            ...
            if (ConnectedWeb3Provider.web3!==undefined && ConnectedWeb3Provider.web3!==null){
                let accounts = await ConnectedWeb3Provider.web3.eth.getAccounts().catch(() => { });
    ...
    const getNetwork = async () =>{
        ...
        try {
            const result = await ConnectedWeb3Provider.web3.eth.net.getId().catch(() => { });
            //console.log(result)
